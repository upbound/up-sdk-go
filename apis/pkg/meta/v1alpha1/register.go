...
const (
	...
	// ControllerKind is the kind of an Controller.
...
var (
	...
	// ControllerGroupVersionKind is the GroupVersionKind for the Controller type.
	ControllerGroupVersionKind = SchemeGroupVersion.WithKind(ControllerKind)
)

func init() {
	SchemeBuilder.Register(&Controller{})
}
