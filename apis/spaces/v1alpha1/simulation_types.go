...
// TODO(negz): Move this to up-sdk-go.
...
// Simulation represents a single backup of a ControlPlane.
...
// SimulationSpec defines a backup over a set of ControlPlanes.
...
// SimulationState represents the state or lifecycle of a simulation.
