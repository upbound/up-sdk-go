...
func (in *BackupDefinition) DeepCopyInto(out *BackupDefinition) {
	*out = *in
	...
	if in.IncludedExtraResources != nil {
		in, out := &in.IncludedExtraResources, &out.IncludedExtraResources
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *BackupStatusDetails) DeepCopyInto(out *BackupStatusDetails) {
	*out = *in
	if in.SharedBackupConfig != nil {
		in, out := &in.SharedBackupConfig, &out.SharedBackupConfig
...
func (in *LocalCommonCredentialSelectors) DeepCopyInto(out *LocalCommonCredentialSelectors) {
	*out = *in
	if in.Fs != nil {
		in, out := &in.Fs, &out.Fs
		*out = new(commonv1.FsSelector)
		**out = **in
	}
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = new(commonv1.EnvSelector)
		**out = **in
	}
	if in.SecretRef != nil {
